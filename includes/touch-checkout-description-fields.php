...
function touch_description_fields( $description, $payment_id ) {
    ...
    woocommerce_form_field(
        ...
        array(
            'type' => 'select',
            'label' => __( 'Payment Network', 'touch-payments-woo' ),
            'class' => array( 'form-row', 'form-row-wide' ),
            'required' => true,
            'options' => array(
                'none' => __( 'Select Phone Network', 'touch-payments-woo' ),
                'mtn_mobile' => __( 'MTN Mobile Money', 'touch-payments-woo' ),
                'airtel_money' => __( 'Airtel Money', 'touch-payments-woo' ),
            ),
        )
    );
